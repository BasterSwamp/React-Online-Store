export const feedbackDataCustomers = [
  {
    id: 1,
    name: "Sarah M.",
  ...
  },
  {
    id: 4,
    name: "Emma R.",
    text: "Shop.co has completely transformed the way I shop for clothes. Their curated collections and high-quality fabrics make it a go-to destination for fashion enthusiasts.",
    rate: 5,
  },
  {
    id: 5,
    name: "Michael P.",
    text: "I've received so many compliments on the outfits I purchased from Shop.co. The attention to detail in their designs is phenomenal.",
    rate: 4,
  },
  {
    id: 6,
    name: "Sophia T.",
    text: "Shop.co's user-friendly website and quick delivery have made my shopping experience a breeze. Highly recommended!",
    rate: 4,
  },
  {
    id: 7,
    name: "Daniel H.",
    text: "What sets Shop.co apart is their exceptional customer service. I had an issue with sizing, and they resolved it promptly with no hassle.",
    rate: 5,
  },
  {
    id: 8,
    name: "Olivia C.",
    text: "The vibrant colors and trendy patterns from Shop.co are exactly what I was looking for to refresh my wardrobe.",
    rate: 4,
  },
  {
    id: 9,
    name: "Ethan W.",
    text: "It's rare to find a store that consistently delivers both quality and affordability, but Shop.co does just that!",
    rate: 5,
  },
  {
    id: 10,
    name: "Charlotte B.",
    text: "I love how Shop.co stays ahead of fashion trends. Their collections are fresh, modern, and absolutely worth every penny.",
    rate: 4,
  },
];
...
export const productsData = [
  [
    ...
    {
      id: 20,
      title: "Aurus Silver Comfort-Fit Headphones",
      rate: 4,
      price: 28,
      description:
